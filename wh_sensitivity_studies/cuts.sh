...
mkdir -p cuts
rooptimize cut $(echo $files) --supercuts=supercuts/supercuts_${tag}.json -o cuts/cuts_${tag}${suffix} --numpy --eventWeight "weight_mc" --weightsFile ../weights_qqbb.json --tree nominal --ncores=16
